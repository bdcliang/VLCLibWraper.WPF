...
{
    public delegate IntPtr lock_cb(IntPtr opaque,  IntPtr planes);
    public delegate void unlock_cb(IntPtr opaque, IntPtr picture,  IntPtr planes);
    ...
    public static class LibVlcMethods
    {
        ...
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr libvlc_media_new_locationx(IntPtr p_instance, [MarshalAs(UnmanagedType.LPStr)] string psz_mrl);
        ...
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern bool libvlc_media_player_is_playing(IntPtr p_mi);
        ...
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern void libvlc_video_set_format(IntPtr mp, [MarshalAs(UnmanagedType.LPArray)] char[] chroma, int width, int height, int pitch);
